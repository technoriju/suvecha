                        ...
                        <div class="page-wrapper">
                            ...
                            <!-- <div class="row">
                                ...
                                <?php
                                 if($_GET[del])
                                 {
                                   $del=mysqli_query($con,"delete from `unit` where `unit_id`='$_GET[del]'");
                                   if($del){ header("location:unit.php"); } 
                                 }
                                ?>
                                 <div class="row">
                                <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="unit" type="text" class="form-control" id="" placeholder="Unit Name" required>
                                                        </div>
                                    ...
                                    <?php
                                      if($_POST['sub']=="submit")
                                      {
                                        ...
                                        $qry=mysqli_query($con,"insert into `unit` values('','$unit')");
                                    ?>
                                          <script>              
                                              swal({
                                                    title: "Great job!",
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $c=0;
                                                        $qry=mysqli_query($con,"select * from `unit` order by `unit_id` desc");
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-2 mr-2">
                                                                    ...
                                                                    <div class="dropdown-menu"> 
                                                                        <a class="dropdown-item" href="unit.php?del=<?php echo $row[unit_id] ?>" onclick="return Delete();">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr><?php } ?>                                      
