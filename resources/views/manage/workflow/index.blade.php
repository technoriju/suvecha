@include('workflow.Wlayouts.head')
<section class="totalFirstScreen">
	...
	<div class="longBtnWrap">
		<a href="doctors & pharmacy.html" class="btn">Cellrox Doctor<i class="fa fa-search"></i></a>
		<a href="pharmacy.html" class="btn btn_blu">  Cellrox Pharmacy <i class="fa fa-list-ol"></i></a>
	</div>
</section>
