                                    ...
                                    <div class="card daily-sales">
                                        <div class="card-block">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-12">
                                                    <h3 class="f-w-300 d-flex align-items-center m-b-0">{{$last_one_year_sale ?? 0}}</h3>
                                                </div>
                                            </div>
                                            <h6 class="mt-3 mb-1">Today Sell</h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-12">
                                                    <h3 class="f-w-300 d-flex align-items-center m-b-0">{{$today_sale ?? 0}}</h3>
                                                </div>
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="card Monthly-sales">
                                        <div class="card-block">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-12">
                                                    <h3 class="f-w-300 d-flex align-items-center m-b-0">{{$last_one_year_profit ?? 0}}</h3>
                                                </div>
                                            </div>
                                            <h6 class="mt-3 mb-1">Today Profit</h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-12">
                                                    <h3 class="f-w-300 d-flex align-items-center m-b-0">{{$today_profit ?? 0}}</h3>
                                                </div>
                                                <div class="col-12 text-right">
                                                    <p class="m-b-0"><i class="fas fa-long-arrow-alt-right"></i> Login</p>
                                                </div>
