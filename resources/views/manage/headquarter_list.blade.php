@extends('manage.layouts.common-template')
    @push('title')
        <title>Pharmacy - Headquarter List</title>
    @endpush
    @push('style')
        <style>
                                                    ...
                                                    @if(isset($data) && count($data)>0)  @php $count=0 @endphp
                                                        @foreach ($data as $val)  @php $count++ @endphp
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{url('/manage/headquarter'.'/'.$val->id.'/edit')}}">Edit</a> |
              ...
              $.ajax(
                {
                    ...
                    success: function (data){
                        ...
                        swal({
                            title: "Great job!",
                            text: "Headquarter Data Deleted",
                            type: "success"
                        }).then(function() {
                            window.location = "/manage/headquarter";
                        });
                    }
                });
           }
